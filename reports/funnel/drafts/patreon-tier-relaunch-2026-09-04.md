...
**Rename note (2026-09-25, Rio, E108):** the operator renamed the tiers overnight on 09-25 while the gate read HOLD — $1 "Support Tier" → **Espresso Shot**, $3 "Tip Jar - Curious Simmer" → **Cappuccino**, $5 "Extra Support" → **Large Latte**. Prices unchanged; no $10 tier; $1 tier still published. Old names below are the 09-04 snapshot and are kept verbatim. Post-rename watch: `reports/funnel/patreon-rename-watch-2026-09-25.md` (`--anchor rename`).
