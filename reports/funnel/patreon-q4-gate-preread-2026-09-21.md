# Q4 gate pre-read — 2026-09-21 (gate reads 2026-09-22)

_Generated 2026-09-21T10:51:53.273Z by `scripts/agents/patreon-q4-gate-preread.ts` (E69). Read-only; Patreon Members API + production DB; counts only. The rule below was written on 2026-09-08 — this file applies it, it does not choose it._
...
| Input | Value | Leg |
|---|--:|---|
| Paid patrons (API) | 54 (9×$1, 43×$3, 1×$5, 1×$8) ≈ $150.50/mo · free 5409 · former 230 | |
| Paid joins since 2026-09-08 | 10 in 13.5 d → **22.5/mo pace** (perk tier 5; 7d 3) | joins ≥ 17/mo: **PASS** |
| Paid-and-connected (id join) | **0** of 54 paid = 0% (by email 0; 54/54 paid rows carry an id; 52/52 linked rows carry one) | ≥ 1/3 connected: **FAIL** |
| Cancels since 2026-09-08 (last charge on/after anchor) | 1 → 2.3/mo pace (7d 0) | cancels > 16/mo → revert copy: **no** |
...
52 site accounts have a Patreon login. Each Patreon id looked up in the campaign's 5693 member rows:

| Class | Accounts | Share |
|---|--:|--:|
| Active (paying) patron | 0 | 0% |
| Free member of the campaign | 4 | 7.7% |
| Former patron | 0 | 0% |
| Declined (payment failed) | 0 | 0% |
| Not in the campaign at all | 48 | 92.3% |
| No Patreon id stored | 0 | 0% |

- Largest class: **not in campaign** (48 of 52).
- 48 of 52 are Patreon-only site accounts (created by the Connect click itself — no credentials login); 4 linked an existing account. 51 of 52 were created on/after 2026-09-08; premium-flagged among them: 0.
- Linked-account users by creation day: 08-20: 1 · 09-08: 5 · 09-09: 10 · 09-10: 4 · 09-11: 6 · 09-12: 3 · 09-13: 3 · 09-14: 3 · 09-15: 1 · 09-16: 2 · 09-18: 2 · 09-19: 6 · 09-20: 5 · 09-21: 1.
