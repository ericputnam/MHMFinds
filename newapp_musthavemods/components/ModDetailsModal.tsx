          ...
          <div className="absolute top-6 left-6">
             {mod.isMaxisMatch ? (
                 <div className="bg-sims-green/90 backdrop-blur-md px-3 py-1.5 rounded-lg text-xs font-bold text-white shadow-lg flex items-center gap-2 border border-white/10">
                   <Layers className="w-3.5 h-3.5" /> Maxis Match
                 </div>
              ) : (
                <div className="bg-sims-pink/90 backdrop-blur-md px-3 py-1.5 rounded-lg text-xs font-bold text-white shadow-lg flex items-center gap-2 border border-white/10">
                  <Sparkles className="w-3.5 h-3.5" /> Alpha CC
                </div>
              )}
          </div>
        </div>
          ...
          <div className="p-8 pb-4">
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
               <div className="bg-gradient-to-br from-white/5 to-white/[0.02] rounded-lg p-3 text-center border border-white/5 hover:border-sims-pink/30 transition-all">
                  <div className="flex items-center justify-center gap-1.5 mb-1">
                    ...
                    <div className="text-white font-bold text-base">{mod.downloadCount}</div>
                  </div>
               ...
               <div className="bg-gradient-to-br from-white/5 to-white/[0.02] rounded-lg p-3 text-center border border-white/5 hover:border-pink-500/30 transition-all">
                  <div className="flex items-center justify-center gap-1.5 mb-1">
                    ...
                    <div className="text-white font-bold text-base">{mod.favoritesCount || 0}</div>
                  </div>
               ...
               <div className="bg-gradient-to-br from-white/5 to-white/[0.02] rounded-lg p-3 text-center border border-white/5 hover:border-cyan-500/30 transition-all">
                  <div className="flex items-center justify-center gap-1.5 mb-1">
                    ...
                    <div className="text-white font-bold text-base">{mod.viewCount || '0'}</div>
                  </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {mod.tags.map(tag => (
                  <span key={tag} className="px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-slate-300 text-xs border border-white/5 transition-all hover:border-white/20 cursor-pointer">
                    {tag}
                  </span>
                ))}
              </div>
